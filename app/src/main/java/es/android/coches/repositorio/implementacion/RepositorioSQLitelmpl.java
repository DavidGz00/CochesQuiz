...
public class RepositorioSQLitelmpl extends SQLiteOpenHelper implements Repositorio<Pregunta> {
    public RepositorioSQLitelmpl(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public RepositorioSQLitelmpl (@Nullable Context context) {
